...
class Driving():    
    ...
    def gradually_accelerate(self, M1vf, M2vf, iterations = 10, acceleration_time = 0.1, total_time = 1):
        ...
        for i in range(iterations):
            self.run_time(M1vi+M1increment*i, M2vi+M2increment*i, acceleration_time / iterations)

        '''Runs at final speed for remaining time'''    
        self.run_time(M1vf, M2vf, total_time - acceleration_time)
